function AutoComplete({ arr, acDivs, setacDivs, closeAllLists, guessSong, attLength, disabled }) {
  ...
  return (
    <div className='autocomplete'>
      <input onChange={autoComplete} id='myInput' type='text' name='myGuess'
        placeholder={placeholder} disabled={disabled} size={placeholder.length} />
